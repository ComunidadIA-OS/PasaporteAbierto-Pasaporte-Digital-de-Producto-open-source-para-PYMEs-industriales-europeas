      ...
      <div className="space-y-4">
        <div className="rounded-lg border border-green-200 bg-green-50 p-5">
          ...
          <p className="mt-1 text-sm text-green-800">
            El paso 6 ha verificado que el DPP está completo. Al publicar se firma con
            Ed25519, se persiste en la BD y se genera el QR + URL pública.
          </p>
        </div>
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-lg border border-green-300 bg-green-50 p-5">
        ...
        <p className="mt-1 text-sm text-green-800">
          Firmado con Ed25519. Identificador conforme a {dpp.gs1_uri.startsWith("urn:iso15459") ? "ISO/IEC 15459 (Art. 77.3 Reg. UE 2023/1542)" : "GS1 Digital Link"}.
        </p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div className="rounded-lg border border-gray-200 bg-white p-5 text-center">
          ...
          <div className="mt-3 flex justify-center gap-2 text-xs">
            <a href={qrPngUrl} download className="text-blue-700 underline">
              descargar PNG
            </a>
            <span className="text-gray-300">·</span>
            <a href={qrSvgUrl} download className="text-blue-700 underline">
              descargar SVG
            </a>
          </div>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-1 block break-all rounded bg-gray-100 p-2 text-xs text-blue-700 underline"
            >
              {fullPublicUrl}
            </a>
