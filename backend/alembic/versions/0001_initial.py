...
def upgrade() -> None:
    ...
    with op.batch_alter_table("published_dpps", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_published_dpps_session_id"), ["session_id"], unique=False
        )
    ...
    with op.batch_alter_table("extracted_fields", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_extracted_fields_field_id"), ["field_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_extracted_fields_session_id"), ["session_id"], unique=False
        )
